...
<%@ include file="../common/head.jsp" %>
	...
	<section class="mt-8 text-xl">
		<div class="container mx-auto px-3">
			<form action="doFindLoginID" onsubmit="logincheck(this); return false;">
				<div class="table-box-type-1 overflow-x-auto">
						<table border="1" class="mx-auto able w-full">
							...
							<tr>
								<td colspan="2"><button class="btn btn-outline btn-warning">아이디 찾기</button></td>
							</tr>
						</table>
				</div>
			</form>
			...
			<div class="btns flex justify-between">
				...
				<a href="findLoginPW" class="btn-text-link btn btn-success">비밀번호 찾기</a>
				</div>
			</div>
